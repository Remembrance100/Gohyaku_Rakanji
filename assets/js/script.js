...
const UI_STRINGS = {
  ja: {
    ...
    "omamori-limit-badge": "⚠ 以下の3種類のお守りの中から1つだけ静止画と動画をダウンロードすることができます。一度ダウンロードすると他のお守りはダウンロードすることができませんのでご注意ください。",
    ...
    "omamori-continue-btn": "ガイド限定のお守りを選択する",
  },
  en: {
    "audio-on": "Audio On",
    "audio-off": "Audio Off",
    ...
    "omamori-limit-badge": "⚠ You may download the still image and video of only one of the three omamori below. Once you download one, you cannot download any of the others, so please choose carefully.",
    ...
    "omamori-continue-btn": "Choose a Guide-Exclusive Omamori",
  },
  ko: {
    "audio-on": "음성 켜기",
    "audio-off": "음성 끄기",
    ...
    "omamori-limit-badge": "⚠ 아래 세 가지 오마모리 중 하나만 정지 이미지와 동영상을 다운로드할 수 있습니다. 한 번 다운로드하면 다른 오마모리는 다운로드할 수 없으니 주의해 주세요.",
    ...
    "omamori-continue-btn": "가이드 한정 오마모리 선택하기",
  },
  zh: {
    "audio-on": "开启音频",
    "audio-off": "关闭音频",
    ...
    "omamori-limit-badge": "⚠ 以下三款御守中，您只能下载其中一款的静态图片和视频。一旦下载，便无法再下载其他御守，敬请注意。",
...
// These are calibrated to the temple grounds map provided, against a
// phone-shaped viewport specifically: the map uses `object-fit: cover`, so
// these percentages are relative to the container, not the image — the crop,
// and therefore the apparent position, shifts with the screen's aspect ratio.
// Phones are what matter here.
